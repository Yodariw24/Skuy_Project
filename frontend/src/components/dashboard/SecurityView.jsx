...
function SecurityView({ user, qrCode, onGenerateQR, onVerify, onDisable, otp, setOtp, loading }) {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 p-4 font-sans">
        ...
        <div className="flex items-center justify-between relative z-10">
          <div className="space-y-1 text-left">
            ...
            <p className="text-slate-400 text-[10px] font-black uppercase tracking-[0.3em] text-left">
              Mari jaga identitas <span className="text-violet-600">@{user?.username}</span> tetap aman.
            </p>
          </div>
      ...
      {/* FOOTER TIPS */}
      <div className="bg-amber-50/50 p-6 rounded-3xl border border-amber-100 flex gap-4 items-center text-left">
