            ...
            {!isVerifying ? (
              ...
              <div className="space-y-8 text-center flex flex-col items-center">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-slate-500 font-bold text-[11px] uppercase leading-relaxed max-w-sm mx-auto italic text-center text-left">
              ...
              <div className="space-y-8 flex flex-col items-center">
                <div className="text-center space-y-2">
                   ...
                   <h3 className="text-xl font-black italic uppercase text-slate-950 tracking-tighter text-center">Verify Identity Node</h3>
                   <p className="text-[10px] font-black text-slate-400 uppercase italic text-center">Input 6-digit kode dari WA/Email ariwirayuda24</p>
                </div>
                <div className="max-w-xs mx-auto space-y-6 w-full text-center">
                    <input 
                      ...
                      placeholder="••••••" 
                      autoFocus
                      className="w-full bg-slate-50 border-4 border-slate-950 p-6 rounded-[2rem] text-center text-5xl font-black tracking-[0.4em] outline-none focus:bg-white focus:ring-4 focus:ring-violet-50 transition-all placeholder:text-slate-200 shadow-inner"
                      value={otp} 
